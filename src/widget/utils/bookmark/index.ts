...
const parseConfig = {
  ...
  getTag: (node: any) => node.nodeName.toLowerCase(),
  getName: (node: any) => node.textContent,
  setAttrs(node: any, htmlNode: any) {
 ...
 * @returns {Array} 嵌套数组
 */
function parse(string: any, options?: any) {
 ...
 */
function stringify(tree: any, options: any) {
